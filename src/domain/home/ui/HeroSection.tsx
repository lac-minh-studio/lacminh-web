...
import { cn } from '@/domain/home/lib/utils'
      ...
      <div className="relative z-10 w-full content-container text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center">
          <Link href={primaryCTA.href} className="w-full sm:w-auto">
            <Button className="font-bold rounded-lg transition-all active:scale-95 bg-primary text-text-light shadow-x-0 hover:bg-primary/90 shadow-(--shadow-neu-cta) leading-0 px-8 sm:px-10 py-4 sm:py-5 text-sm sm:text-md w-full sm:w-auto">
              {primaryCTA.label}
            </Button>
          </Link>
          <Link href={secondaryCTA.href} className="w-full sm:w-auto">
            <Button className="font-bold rounded-lg transition-all active:scale-95 border-2 border-text-light text-text-light bg-transparent backdrop-blur-sm hover:bg-white/10 leading-0 px-8 sm:px-10 py-4 sm:py-5 text-sm sm:text-md w-full sm:w-auto">
              {secondaryCTA.label}
            </Button>
          </Link>
        </div>
