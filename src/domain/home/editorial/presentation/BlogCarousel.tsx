...
import type { IBlogPost } from '../model/editorial'
    ...
    <section aria-label="Tin Nổi Bật" className="w-full h-auto">
      <article className="glass-card rounded-2xl overflow-hidden shadow-(--shadow-neu-light) h-auto">
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="relative lg:w-2/5 p-5 lg:p-6 lg:pb-20 flex flex-col gap-4 lg:self-start h-full">
            {/* Category pill */}
            ...
            <div className="relative z-10 flex items-center justify-center gap-3 mt-auto mb-0 pt-2 lg:absolute bottom-5 right-5 max-md:w-full">
              <button
                type="button"
                onClick={handlePrev}
