...
import { GAME_PROJECTS } from '@/domain/home/portfolio/application'
    ...
    <section id="projects" className="py-12 md:py-20 lg:py-32 bg-surface relative overflow-hidden">
      <div className="content-container relative z-10">
        ...
        <div className="mt-10 md:mt-20 p-6 md:p-10 bg-surface-dark rounded-2xl sm:rounded-3xl flex flex-col md:flex-row items-center justify-between gap-6 sm:gap-8 border border-primary/30">
          ...
          <Button className="font-bold rounded-lg transition-all active:scale-95 bg-primary text-text-light hover:bg-primary/90 leading-0 whitespace-nowrap px-10 py-4 flex items-center gap-3">
