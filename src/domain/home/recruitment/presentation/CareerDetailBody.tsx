...
import type { IJobPosition } from '../model/recruitment'
import type { IJobSummaryItem } from '@/domain/home/recruitment/application'
...
export function CareerDetailBody({ job, summary }: CareerDetailBodyProps) {
  return (
        ...
        <aside className="order-1 space-y-6 lg:order-2 lg:sticky lg:top-20">
          <div className="glass-card rounded-3xl border border-primary/20 p-7 shadow-(--shadow-neu-light)">
            ...
            <div className="mt-8 space-y-3">
              <Button
                isDisabled
                className="font-bold rounded-lg transition-all active:scale-95 bg-primary text-text-light shadow-x-0 hover:bg-primary/90 shadow-(--shadow-neu-cta) leading-0 h-11.5 w-full"
              >
                Ứng tuyển ngay
