...
import type { Department } from '../model/recruitment'
import type { IJobCardView } from '@/domain/home/recruitment/application'

const DEPARTMENT_BADGE: Record<Department, string> = {
