...
export const JOB_POSITIONS: IJobPosition[] = [
  {
    id: 'unity-gameplay-intern',
    slug: 'unity-gameplay-intern',
    title: 'Unity Gameplay Intern',
    department: 'Game',
    description:
      'Tham gia phát triển gameplay systems cho SEN CITY — tựa game pet simulation chữa lành với AI behavior, emotional interaction và social sandbox — cùng mentor đồng hành sát sao trong môi trường production thực tế.',
    skills: ['Unity', 'C#', 'Gameplay Programming', 'Animation System'],
    level: 'intern',
    location: 'Remote',
    workType: 'Full time',
    intro:
      'Tại Lạc Minh Studio, bạn sẽ trực tiếp tham gia xây dựng gameplay systems cho SEN CITY — một tựa game pet simulation nơi thú cưng là trung tâm của toàn bộ trải nghiệm cảm xúc. Bạn sẽ làm việc với các hệ thống AI behavior, pet interaction, emotion reaction, housing interaction và gameplay loop xoay quanh việc chăm sóc và gắn kết với pet. Đây không phải vị trí chỉ làm prototype tutorial — bạn sẽ được tham gia quy trình phát triển game production thực tế, học cách xây dựng gameplay scalable, clean architecture và tối ưu cho mobile dưới sự hướng dẫn của mentor giàu kinh nghiệm. Vị trí này phù hợp với các bạn yêu thích game simulation/cozy, thích lập trình gameplay và muốn phát triển tư duy làm game chuyên nghiệp.',
    responsibilities: [
      'Phát triển gameplay systems cho SEN CITY bằng Unity và C#, bao gồm pet interaction, AI behavior, status system và object interaction.',
      'Xây dựng logic gameplay dựa trên state machine, event system và các gameplay loop liên quan đến chăm sóc pet.',
      'Tích hợp animation, visual feedback và interaction flow nhằm tạo cảm giác sống động cho pet và môi trường.',
      'Phối hợp cùng game designer và artist để triển khai gameplay feature hoàn chỉnh, tối ưu cho trải nghiệm mobile.',
      'Tham gia review code, tiếp thu phản hồi nhanh và cải thiện chất lượng hệ thống theo quy trình production thực tế.',
    ],
    requirements: [
      'Có nền tảng Unity và C# cơ bản, hiểu OOP và biết tổ chức code rõ ràng.',
      'Biết sử dụng Unity Animator, prefab và các thành phần gameplay cơ bản trong Unity.',
      'Có tư duy gameplay/system-driven, thích tìm hiểu cách game simulation vận hành thay vì chỉ làm tutorial đơn giản.',
      'Ưu tiên ứng viên có project cá nhân, game jam hoặc prototype gameplay từng thực hiện.',
      'Chủ động học hỏi, nhận phản hồi cởi mở và có tinh thần teamwork — chúng tôi đánh giá tiềm năng phát triển hơn CV.',
    ],
    hiringProcess: [
      'Lọc hồ sơ',
      'Phỏng vấn culture fit (online)',
      'Gameplay test (take-home)',
      'Thông báo kết quả',
    ],
    summary: [
    ...
    linkHref: '/careers/unity-gameplay-intern',
  },
    {
